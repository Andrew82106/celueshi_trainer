...
Page({
    ...
    submitAllTranslations() {
        ...
        wx.navigateTo({
            url: `/packageTrain/pages/translate-review/translate-review?content=${encodeURIComponent(JSON.stringify(this.data.content))}&translations=${encodeURIComponent(JSON.stringify(this.data.userTranslations))}&translationMode=${encodeURIComponent(JSON.stringify(this.data.translationMode))}`
        });
    },

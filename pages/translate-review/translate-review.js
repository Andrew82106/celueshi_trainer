...
Page({
    ...
    onLoad(options) {
        try {
            ...
            console.log('[DEBUG] 原始translations参数:', options.translations);
            
            const content = options.content ? JSON.parse(decodeURIComponent(options.content)) : [];
            const translations = options.translations ? JSON.parse(decodeURIComponent(options.translations)) : [];
    ...
    async startEvaluation() {
        try {
            ...
            console.log('[DEBUG] 完整评测结果：', evaluationResult);
